        ...
        async with base_crawler as crawler:
            ...
            if sort_type != None:
                if filter_selected == None:
                    filter_selected = {}
                filter_selected["sort_type"] = str(sort_type)
            if content_type != None:
                if filter_selected == None:
                    filter_selected = {}
                filter_selected["content_type"] = str(content_type)
            if publish_time != None:
                if filter_selected == None:
                    filter_selected = {}
                filter_selected["publish_time"] = str(publish_time)
            if filter_duration != None:
                if filter_selected == None:
                    filter_selected = {}
                filter_selected["filter_duration"] = filter_duration
            ...
            params = PostSearch(
                ...
                is_filter_search=0 if filter_selected == None else 1,
            )
            ...
            endpoint = f"{DouyinAPIEndpoints.POST_SEARCH}?{urlencode(params_dict)}&a_bogus={a_bogus}"
